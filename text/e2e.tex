...
\autoref{fig:accflops_resnet_cars, fig:accflops_resnet_imagenet} shows the accuracy achieved by static and dynamic resolution approaches across a range of crop sizes on ImageNet.
